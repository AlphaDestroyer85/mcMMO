...
public class Config extends AutoUpdateConfigLoader {
    ...
    public int getPartyLevelCap() { return config.getInt("Party.Leveling.Level_Cap", 10); }
    public int getPartyExpCurveMultiplier() { return config.getInt("Party.Leveling.Xp_Curve_Multiplier", 3); }
